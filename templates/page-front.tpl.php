...
<div id="grid-996" class="gridwrpr">
  ...
  <div id="two-col-container">  
    ...
    <div id="<? print $content_id ?>"><!-- #content or #content-wide -->
  ...
  <?php if($left) : ?>
    <div id="<?php print $left_id ?>"><!-- #left_col or #left-sm -->
<!--    <div class="mod-floatbx" style="margin-top: 0pt;"> CAN WE GET RID OF THIS? -->
	<!-- left sidebar -->
	<?php print $left; ?>
	<!-- /left sidebar-->
    </div><!-- /#left -->
  ...
  <div id="<? print $center_id ?>"><!-- #center_col or #center-col-wide -->
      <?php if ($content_bottom): ?>
        <div id="content-bottom" class="region region-content_bottom clear-block">
          <?php print $content_bottom; ?>
        </div> <!-- /#content-bottom -->
      <?php endif; ?>
  </div><!-- /#center_col or /#center-col-wide -->
